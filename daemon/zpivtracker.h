...
private:
    ...
    robin_hood::unordered_node_map<uint256, CMintMeta> mapSerialHashes;
    robin_hood::unordered_node_map<uint256, uint256> mapPendingSpends; //serialhash, txid of spend
