...
std::vector<CMintMeta> SelectMintsFromList(const CAmount nValueTarget, CAmount& nSelectedValue,
                                               ...
                                               const robin_hood::unordered_node_map<libzerocoin::CoinDenomination, CAmount> mapDenomsHeld,
                                               int& nNeededSpends
                                               );
...
int calculateChange(
    ...
    const robin_hood::unordered_node_map<libzerocoin::CoinDenomination, CAmount>& mapOfDenomsHeld,
    robin_hood::unordered_node_map<libzerocoin::CoinDenomination, CAmount>& mapOfDenomsUsed);
